...
$((function() {
    var e, t = $(".datatables-basic"), a = $(".dt-complex-header"), s = $(".dt-row-grouping"), n = $(".dt-multilingual");
        ...
        columnDefs: [{
            ...
            render: function(e, t, a, s) {
                var n = a.avatar
                  ...
                  , l = a.post;
                if (n)
                    var o = '<img src="' + assetsPath + "img/avatars/" + n + '" alt="Avatar" class="rounded-circle">';
                else {
                    var d = ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())]
                      , i = (r = a.full_name).match(/\b\w/g) || [];
                    o = '<span class="avatar-initial rounded-circle bg-label-' + d + '">' + (i = ((i.shift() || "") + (i.pop() || "")).toUpperCase()) + "</span>"
                }
                return '<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper"><div class="avatar me-2">' + o + '</div></div><div class="d-flex flex-column"><span class="emp_name text-truncate">' + r + '</span><small class="emp_post text-truncate text-muted">' + l + "</small></div></div>"
            }
        }, {
    ...
    var r = 101;
    if (fv.on("core.form.valid", (function() {
    ...
    if (s.length) {
        ...
        $(".dt-row-grouping tbody").on("click", "tr.group", (function() {
            var e = l.order()[0];
            2 === e[0] && "asc" === e[1] ? l.order([2, "desc"]).draw() : l.order([2, "asc"]).draw()
        }
        ))
    }
    if (n.length)
